...
The subject remains configurable. The first implementation should use the configured subject as the expected CloudEvent `type`, matching the existing `function-service` event handling pattern.
